...
namespace oomph {
    ...
    public:    // ctors
        ...
        rank_topology(rank_topology const&) = default;
        rank_topology(rank_topology&&) noexcept = default;
        rank_topology& operator=(rank_topology const&) = default;
    ...
    public:    // member functions
        ...
        set_type const& local_ranks() const noexcept { return m_rank_set; }
