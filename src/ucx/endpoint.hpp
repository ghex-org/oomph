...
#define OOMPH_ANY_SOURCE (int) -1
    ...
    struct endpoint_t
    {
        ...
        endpoint_t(
            rank_type rank, ucp_worker_h local_worker, address_t const& remote_worker_address)
          : m_rank(rank)
        ...
        endpoint_t(endpoint_t const&) = delete;
        endpoint_t& operator=(endpoint_t const&) = delete;
        ...
        ucp_ep_h const& get() const noexcept { return m_ep; }
    };
