...
#define OOMPH_UCX_ANY_SOURCE_MASK 0x0000'0000'0000'0000ul
#define OOMPH_UCX_SPECIFIC_SOURCE_MASK 0x0000'0000'ffff'fffful
#define OOMPH_UCX_TAG_MASK 0xffff'ffff'0000'0000ul
    ...
    public:    // ctors
          ...
          , m_cancel_recv_req_queue(128)
        {
            ...
            // define valid fields
            context_params.field_mask = UCP_PARAM_FIELD_FEATURES    // features
            ...
            context_params.tag_sender_mask = 0xffff'ffff'ffff'fffful;
        ...
        void progress()
        {
            ...
            m_recv_req_queue.consume_all([](detail::shared_request_state* req) {
    ...
    template <>
    inline region register_memory<context_impl>(context_impl& c, void* ptr, std::size_t)
    {
    ...
    template <>
    inline region register_device_memory<context_impl>(context_impl& c, int, void* ptr, std::size_t)
    {
        return c.make_region(ptr);
    }
#endif
