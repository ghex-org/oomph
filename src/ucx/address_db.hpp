...
namespace oomph {
    struct type_erased_address_db_t
    {
        struct iface
        {
            ...
            virtual void init(address_t const&) = 0;
        ...
        struct impl_t final : public iface
        {
            ...
            void init(address_t const& addr) override { m_impl.init(addr); }
        ...
        inline void init(address_t const& addr) { m_impl->init(addr); }
