...
namespace oomph {
    ...
    public:
        ...
        mpi_request send(context_impl::heap_type::pointer const& ptr, std::size_t size,
            ...
            std::size_t* scheduled)
        {
            ...
            else
            {
                auto s = m_req_state_factory.make(
                    m_context, this, scheduled, dst, tag, std::move(cb), req);
                s->create_self_ref();
            ...
            std::size_t* scheduled)
        {
            ...
            {
                auto s = m_req_state_factory.make(
                    m_context, this, scheduled, src, tag, std::move(cb), req);
                s->create_self_ref();
