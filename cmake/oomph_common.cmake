...
function(oomph_target_compile_options target)
    ...
    $<${cxx_lang_gnu}:$<BUILD_INTERFACE:-Wall -Wextra -Wpedantic -Wno-unknown-pragmas -Wno-unused-local-typedef>>
    $<${cxx_lang_clang}:$<BUILD_INTERFACE:-Wno-c++17-extensions -Wno-unused-lambda-capture>>
    $<${cxx_lang_intel}:$<BUILD_INTERFACE:-Wall -Wextra -Wno-unknown-pragmas>>
